...
namespace FallDetectionApp.Droid
{
    ...
    public class LocationHandler
    {
        ...
        public static LocationHandler Current { get; }
        ...
        public static void StartLocationService()
        {
            ...
            new Task(() =>
            {
                ...
                Log.Debug("LocationHandler", "Calling StartService");
                ...
                Log.Debug("LocationHandler", "Calling service binding");
        ...
        public static void StopLocationService()
        {
            ...
            Log.Debug("LocationHandler", "StopLocationService");

            // Unbind from the LocationService; otherwise, StopSelf (below) will not work:
            if (locationServiceConnection != null)
            {
                Log.Debug("LocationHandler", "Unbinding from LocationService");
            ...
            {
                Log.Debug("LocationHandler", "Stopping the LocationService");
